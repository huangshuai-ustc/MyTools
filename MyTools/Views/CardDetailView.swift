...
struct CardDetailView: View {
    ...
    var body: some View {
        NavigationStack { Form {
            Section("基本信息") { field("银行", card.bankName); field("支行", card.branchName); field("卡种", card.cardType); LabeledContent("状态") { CardStatusText(status: card.status) }; field("持卡人", card.holderName) }
